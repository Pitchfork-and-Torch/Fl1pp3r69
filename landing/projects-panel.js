  ...
  var PROJECTS = [
    {
      ...
      isHere: function (h, p) {
        // Apex music site only - not project subdomains
        return /^(www\.)?jonbailey\.xyz$/i.test(h) && !/^\/theater(\/|$)/.test(p);
      },
    },
    {
      id: 'axiom',
    ...
    },
    {
      ...
      url: 'https://groklink.jonbailey.xyz/',
      isHere: function (h, p) {
    ...
    },
    {
      id: 'skycache',
      name: 'SkyCache',
      blurb: 'Mesh / DTN cache',
      url: 'https://skycache.jonbailey.xyz/',
      isHere: function (h) {
        return /^skycache\.jonbailey\.xyz$/i.test(h);
      },
    },
    {
      id: 'trench',
